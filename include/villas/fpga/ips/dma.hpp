...
public:
	...
	static constexpr
	const char* s2mmPort = "S2MM";

	static constexpr
	const char* mm2sPort = "MM2S";
...
private:
	...
	static constexpr
	char mm2sInterface[] = "M_AXI_MM2S";

	static constexpr
	char s2mmInterrupt[] = "s2mm_introut";
	static constexpr
	char s2mmInterface[] = "M_AXI_S2MM";

	// Optional Scatter-Gather interface to access descriptors
	static constexpr
	char sgInterface[] = "M_AXI_SG";
	...
	static constexpr
	size_t requestedRingBdSize = 2048;
	static constexpr
	size_t requestedRingBdSizeMemory = requestedRingBdSize * sizeof(XAxiDma_Bd);
